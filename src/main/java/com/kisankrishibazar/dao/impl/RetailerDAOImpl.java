...
public class RetailerDAOImpl implements RetailerDAO {
	...
	public List<UserWithItem> getStock(String item, int quantity, float lat,
		...
		String sql = "select l.lat,l.longt,l.name,l.Address,l.Phone, o.username,o.quotedPrice,o.Qty from Commodity c, OrderAvailable o LEFT JOIN OrderSuccesfulHistory os ON( o.username != os.FrmrUserName) , login l where c.id=o.id and l.type='F' and l.username = o .userName  and  o.username != os.FrmrUserName and c.English = ?";
